...
export default async function ProfilePage() {
    ...
    const { data: profile } = (await supabase
        .from('profiles')
        .select('full_name, company_name, phone, plan, is_subscribed, company_logo_url, bank_details')
        .eq('id', user.id)
        .maybeSingle()) as {
            data: Pick<ProfileRecord, 'full_name' | 'company_name' | 'phone' | 'plan' | 'is_subscribed' | 'company_logo_url' | 'bank_details'> | null;
        };
